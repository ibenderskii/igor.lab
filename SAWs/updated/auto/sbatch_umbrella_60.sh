#!/bin/bash
#SBATCH --job-name=Umbrella60
#SBATCH --output=Umbrella60_%j.out
#SBATCH --error=err_%j.err
#SBATCH --partition=tokmakoff
#SBATCH --account=pi-tokmakoff
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32       # = the window count printed by --show_window_design
#SBATCH --nodes=1
#SBATCH --mem=48G
...
N=60
TAIL_SLOPE=5.0                    # 5.0 gives exactly 32 windows; 6.0 gives 33 and doubles wall time
UMBRELLA_K=0.30
WINDOW_SPACING=3
